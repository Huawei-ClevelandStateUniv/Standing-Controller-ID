...
import numpy as np
from StandingModel_3DOF_FPDR import Model
...
x = x_traj[start_nodes:start_nodes+num_nodes, 1:7]*3.1416/180.0
...
uc = np.zeros(num_states*num_nodes+num_par)
lc = np.zeros(num_states*num_nodes+num_par)

Question = Model(x_f, accel_f, num_nodes, num_states, num_par,
                 interval, parameter, scaling = 100.0, integration_method ='backward euler')
